import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_CewNx4IW.mjs";
import { y as detector } from "./path_Cwtskwsb.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_BSRC8jgF.mjs";
//#region node_modules/.pnpm/astro@7.2.6_@emnapi+core@1._1809f07fe5d6f0af82302b96e1e45f4f/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_DSJ_Ls8e.mjs")).default;
	} catch {
